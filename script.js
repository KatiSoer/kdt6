...
function GetMap() {
    ...
    function ulikoolClicked(e) { // Kasutasin juhendit, aga ei tööta - https://learn.microsoft.com/en-us/bingmaps/v8-web-control/map-control-concepts/infoboxes/infobox-when-pushpin-clicked
